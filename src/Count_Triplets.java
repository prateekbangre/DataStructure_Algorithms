...
/**
 * @author prateek.bangre on 08/03/20.
 * @Project DataStructure_Algorithms
 */
/*
Vikrant is at his college’s fest, and being a true foodie, he went straight away to the food corner in hope of
getting his hands on some delicacies. There are N stalls in the food corner numbered 1 to N, and the ith stall has
Ai people standing in front of it. Each stall takes a minute to serve one person. Vikrant will initially join the
line for the first stall, but being an impatient guy, he will go on to join the line for the next stall after every
minute if he is not served. (If he is in the line for the last stall, he will join the one for the first stall)
...
The first line of each testcase consists of a positive integer N. The second line consists of N positive integers
